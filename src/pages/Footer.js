    ...
    <footer>
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4">
            <h4>Contacts</h4>
            <p>Address: <a href="https://yandex.ru/maps/213/moscow/house/ulitsa_pushkina_10/Z04YdAFhSkQPQFtvfXpydHplZA==/?ll=37.261318%2C55.635660&z=16"> st. Pushkina, 10, Moscow</a></p>
            <p>Phone: <span>+996 500978933</span></p>
            <p>Email: <a href="https://mail.google.com/mail/u/0/#inbo">info@bookstore.ru</a></p>
          </div>
          <div className="col-md-4">
